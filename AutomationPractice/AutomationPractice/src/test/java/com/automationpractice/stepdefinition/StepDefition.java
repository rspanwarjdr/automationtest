...
public class StepDefition {
	...
	public void User_clicks_on_T_Shirts_tab() throws Throwable {
	...
	@When("^User clicks on Proceed to checkout button on Summary tab$")
	public void User_clicks_on_Proceed_to_checkout_button_on_Summary_tab() throws Throwable {

	}

	@When("^User clicks on Proceed to checkout button on Address tab$")
	public void User_clicks_on_Proceed_to_checkout_button_on_Address_tab() throws Throwable {

	}

	@When("^User accepts the Terms and Condition$")
	public void User_accepts_the_Terms_and_Condition() throws Throwable {

	}

	@When("^User clicks on Proceed to checkout button on Shipping tab$")
	public void User_clicks_on_Proceed_to_checkout_button_on_Shipping_tab() throws Throwable {

	}

	@When("^User choose Pay by bank wire payment option$")
	public void User_choose_Pay_by_bank_wire_payment_option() throws Throwable {
	...
	public void Validate_order_has_been_done() throws Throwable {

	}

	@When("^User clicks on back to order history$")
	public void User_clicks_on_back_to_order_history() throws Throwable {

	}

	@Then("^Validate the recent order in order history$")
	public void Validate_the_recent_order_in_order_history() throws Throwable {
